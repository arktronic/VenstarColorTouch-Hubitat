        ...
        data.sensors.each {
            ...
            if ( createSensorChildDevices ) {
                if ( device == null ) {
                    ...
                    device = addChildDevice( "toggledbits.com", "Venstar Thermostat Sensor", dni, [label: "Venstar Thermostat Sensor - ${it.name}"] )
                } else {
            ...
            if ( device != null ) {
                device.processSensorData( it, state.tempunits )
            }
        }
